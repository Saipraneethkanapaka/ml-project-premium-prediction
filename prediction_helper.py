...
model_rest=load("articrafts/model_rest.joblib")
model_young=load("articrafts/model_young.joblib")
scaler_rest=load("articrafts/scaler_rest.joblib")
scaler_young=load("articrafts/scaler_young.joblib")
